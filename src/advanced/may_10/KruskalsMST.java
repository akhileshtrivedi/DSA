...
public class KruskalsMST {
  ...
  public static void solve(int A, ArrayList<ArrayList<Integer>> B) {
    int V = A-1;
...
//            new Edge(2, 3, 4)));
    ...
    for(int i=0;i<B.size();i++){
      ...
      graphEdges.add(new Edge(B.get(i).get(0),B.get(i).get(1),B.get(i).get(2)));
    }
...
//    al.add(new ArrayList<>(Arrays.asList(2, 3, 4)));
  ...
  {
    System.out.println(i+"  "+Arrays.toString(subsets));
